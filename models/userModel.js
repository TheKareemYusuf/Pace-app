...
// UserSchema.methods.isProfileComplete = function() {
//   const requiredFields = ['firstName', 'lastName', 'email', 'phoneNumber', 'dateOfBirth', 'gender', 'department'];
//   const completeness = requiredFields.every(field => {
//     const isFieldComplete = this[field];
//     if (!isFieldComplete) {
//       console.log(`Incomplete field: ${field}`);
//     }
